...
class __TwigTemplate_e1c707585a10a364eee9e1229990635c extends Template
{
...
($context["alignment"] ?? null)];
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 19
                    yield "      <ul";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->withoutFilter($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [($context["nav_classes"] ?? null)], "method", false, false, true, 19), 19, $this->source), "id"), "html", null, true);
                    yield ">
    ";
                } else {
                    // line 21
...
$context["item"], "url", [], "any", false, false, true, 37), "getOption", ["attributes"], "method", false, false, true, 37), "class", [], "any", false, false, true, 37)) ? (Twig\Extension\CoreExtension::join($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "url", [], "any", false, false, true, 37), "getOption", ["attributes"], "method", false, false, true, 37), "class", [], "any", false, false, true, 37), 37, $this->source), " ")) : ("")), ("nav-link-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source,                     // line 38
$context["item"], "url", [], "any", false, false, true, 38), "toString", [], "method", false, false, true, 38), 38, $this->source)))];
                    // line 41
                    yield "        ";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->getLink($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "title", [], "any", false, false, true, 41), 41, $this->source), $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "url", [], "any", false, false, true, 41), 41, $this->source), ["class" => $this->sandbox->ensureToStringAllowed(($context["link_classes"] ?? null), 41, $this->source)]), "html", null, true);
                    yield "
        ";
                    // line 42
